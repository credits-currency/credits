...
void Bitcoin_CoinControlDialog::updateLabels(Bitcoin_WalletModel *model, Bitcredit_WalletModel *bitcredit_model, QDialog* dialog)
{
    ...
    if (nQuantity > 0)
    {
        ...
        // Fee
        int64_t nFee = bitcoin_payTxFee.GetFee(nBytes);
    ...
    toolTip1 += tr("This means a fee of at least %1 per kB is required.").arg(BitcoinUnits::formatWithUnit(nDisplayUnit, Bitcoin_CTransaction::minTxFee.GetFeePerK())) + "<br /><br />";
    toolTip1 += tr("Can vary +/- 1 byte per input.");

    QString toolTip2 = tr("Transactions with higher priority are more likely to get included into a block.") + "<br /><br />";
    toolTip2 += tr("This label turns red, if the priority is smaller than \"medium\".") + "<br /><br />";
    toolTip2 += tr("This means a fee of at least %1 per kB is required.").arg(BitcoinUnits::formatWithUnit(nDisplayUnit, Bitcoin_CTransaction::minTxFee.GetFeePerK()));
    ...
    toolTip3 += tr("This means a fee of at least %1 is required.").arg(BitcoinUnits::formatWithUnit(nDisplayUnit, Bitcoin_CTransaction::minTxFee.GetFeePerK())) + "<br /><br />";
    ...
    toolTip4 += tr("This means a fee of at least %1 is required.").arg(BitcoinUnits::formatWithUnit(nDisplayUnit, Bitcoin_CTransaction::minTxFee.GetFeePerK()));
